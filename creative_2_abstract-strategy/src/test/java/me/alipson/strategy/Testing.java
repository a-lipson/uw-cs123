...
public class Testing {
    ...
    public void secondCaseTest() {
        ...
        // No optional error messages - up to you if you want your code to be easier to
        // debug!
        for (int i = 0; i < 5; i++) {
            int player = (i % 2) + 1;
        ...
        // At this point, 5 moves have been played, player 1 should have three in a row
        // and
