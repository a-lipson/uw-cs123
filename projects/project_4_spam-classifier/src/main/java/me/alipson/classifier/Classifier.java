...
public abstract class Classifier {
    // Returns whether or not the classifier is able to classify datapoints that
    // match that
    ...
    // corresponding 'labels'. The label for a datapoint at index 'i' within 'data'
    // should be
    ...
    // Returns a map storing the classification accuracy for each of the encountered
    // labels when
    // classifying
