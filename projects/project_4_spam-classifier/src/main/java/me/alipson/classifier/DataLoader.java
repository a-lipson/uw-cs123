...
public class DataLoader {
    ...
    // Constructs a new DataLoader storing and shuffling data from the given file,
    // where labels
    // are taken from the given index, using the given 'toClassifiable' function to
    // convert a
    ...
    // Returns the List of Classifiable data points currently stored by this
    // DataLoader
    ...
    // Shuffles the data and labels stored by the provided DataLoader equally so
    // each label
    ...
    // Shuffles the provided data and label lists equally so each label still
    // corresponds
